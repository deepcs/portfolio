...
export const headData = {
  ...
  description: `front-end developer, responsive design google analytics, web-developer, web-designer,javascript responsive design skilled in Web development and Data analysis having strong knowledge of Teradata, Tableau, MERN Stack, Python, Photoshop, Software Requirements, Software Testing,computer systems analysts, ` // e.g: Welcome to my website
};
